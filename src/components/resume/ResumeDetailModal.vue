    ...
    <div class="radar-chart" :style="{ height: height + 'px' }">
      <svg :viewBox="'0 0 ' + size + ' ' + size" class="radar-svg">
        <g class="grid">
          ...
          />
          <line
            v-for="(item, i) in getNormalizedData()"
            :key="'axis-' + i"
            :x1="center"
            :y1="center"
...
const ScoreProgressBar = {
  ...
  setup(props) {
    ...
    const getBarColor = () => colorMap[props.color] || colorMap.blue
    
    return { getPercentage, getBarColor }
  },
  template: `
    <div class="score-progress-bar">
      ...
      <div class="progress-track">
        <div 
          class="progress-fill" 
          :style="{ width: getPercentage() + '%', background: getBarColor() }"
        ></div>
      </div>
    </div>
  `
